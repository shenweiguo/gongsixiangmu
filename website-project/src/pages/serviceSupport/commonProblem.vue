<template>
  <div class="main">
    ...
    <section class="down-lun">
      <img src="../../assets/images/serviceSupport/se_1.jpg" alt />
    </section>
    <!--图片结束-->
...
<style scoped>
.down-table tr:first-child {
  color: #ffffff;
  background: #01b0f1;
  line-height: 60px;
}
.down-table tr:first-child td {
  padding: 20px 0;
  display: flex;
}
.down-tablei {
...
.down-table table td:last-child {
  border-right: 0px;
}
.down-table {
  display: flex;
